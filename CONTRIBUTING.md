...
To add a dependency whose library requires linking native code, perform the following:
...
To add a dependency whose library does **_not_** require linking native code, perform the following:
